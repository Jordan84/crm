/*==================================
 * by:Etalk——Terwer Green
 * 2018-6-12
 * http:www.etalk365.com
...
+function ($) {
    $.fn.citys = function (options) {
        ...
        var init = function () {
            //初始化默认数据
            proHtml = "<option value=''> - 省 - </option>";
            cityHtml = "<option value=''> - 市 - </option>";
        ...
        function changeProvince(val) {
            cityHtml = "<option value=''> - 市 - </option>"; //添加列表头
            if(typeof val == "undefined"){//未选择具体省市直接返回
                $selCity.html(cityHtml);
                $selArea.html(areaHtml);
                return;
            }
        ...
        function changeCity(val) {
            areaHtml = "<option value=''> - 区 - </option>"; //添加列表头
            if(typeof val == "undefined"){//未选择具体区直接返回
                $selArea.html(areaHtml);
                return;
            }
