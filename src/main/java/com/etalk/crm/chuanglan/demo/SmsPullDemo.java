...
import com.etalk.crm.chuanglan.sms.request.SmsPullRequest;
import com.etalk.crm.chuanglan.sms.response.SmsPullResponse;
...
public class SmsPullDemo {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		System.out.println("response  toString is : " + smsPullResponse.getResult());
